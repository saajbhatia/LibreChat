...
describe('conversation URL synchronization', () => {
  it('keeps a pending CourseWing handoff while the default model spec is applied', async () => {
    ...
    window.history.replaceState({}, '', '/c/new?coursewing=review-session-123');
    ...
    expect(window.location.search).toBe('?spec=course-tutor&coursewing=review-session-123');
  });
});
