...
describe('AuthContextProvider — unauthenticated routes', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it.each(['/', '/c/new', '/c/abc123', '/courses', '/courses/11464', '/workspace/courses'])(
    'requires login for unauthenticated route %s',
    (path) => {
