...
export default function LearnLightIntro() {
  const [activeScreen, setActiveScreen] = useState<Screen | null>(null);

  useEffect(() => {
    const previousTitle = document.title;
    document.title = 'LearnLight — A tutor with your syllabus open';
    return () => {
  ...
  return (
    <main className="ll-page">
      <header className="ll-nav-shell">
        <a className="ll-wordmark" href="#top" aria-label="LearnLight home">
          <span className="ll-wordmark-mark" aria-hidden="true">
            L
          </span>
          <span>LearnLight</span>
        </a>
      ...
      <section className="ll-hero" id="top">
        <div className="ll-hero-copy">
          ...
          <p className="ll-hero-deck">
            LearnLight connects Canvas courses, deadlines, grades, feedback, and files to a tutor
        ...
        <div className="ll-hero-visual">
          ...
          >
            <span className="ll-screen-bar" aria-hidden="true">
              ...
              <i />
              <i />
              <small>learnlight / courses / ap-calculus</small>
            </span>
      ...
      <section className="ll-proof" id="why" aria-label="Why LearnLight works">
      ...
      <section className="ll-stories" id="stories">
        ...
        <article className="ll-featured-story">
          <div className="ll-featured-copy">
            ...
            <p>
              LearnLight sees what is due across courses, what carries weight, and what can wait —
      ...
      <section className="ll-adapts" id="adapts">
        <div className="ll-adapts-copy">
          ...
          <p>
            LearnLight can carry forward goals, pacing, and recurring struggle points. Students can
      ...
      <section className="ll-final-cta">
        <div>
          <p className="ll-eyebrow">LEARNLIGHT</p>
