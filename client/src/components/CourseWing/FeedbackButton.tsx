...
import { useSendFeedbackMutation } from '~/data-provider/CourseWing';
        ...
        <DialogTemplate
          ...
          main={
            <div className="flex flex-col gap-3">
              <label htmlFor="coursewing-feedback-message" className="text-sm text-text-secondary">
                {localize('com_ui_app_feedback_prompt')}
              </label>
              <textarea
                id="coursewing-feedback-message"
                value={message}
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  id="coursewing-feedback-share"
                  aria-labelledby="coursewing-feedback-share-label"
                  checked={shareChat}
                  onCheckedChange={(checked) => setShareChat(checked === true)}
                  disabled={!canShareChat}
                />
                <label
                  id="coursewing-feedback-share-label"
                  htmlFor="coursewing-feedback-share"
