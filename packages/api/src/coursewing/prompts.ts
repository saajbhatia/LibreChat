import {
  ...
  COURSEWING_PERSONA_MARKER,
} from 'librechat-data-provider';
import type { AssistanceLevel, CourseWingPersona } from 'librechat-data-provider';
...
const LEARNING_DEFAULT = [
  `${COURSEWING_TUTOR_MARKER} — set for this conversation]`,
...
const PERSONA_PREAMBLE = [
  `${COURSEWING_PERSONA_MARKER} — set for this conversation]`,
...
const PERSONA_PROMPTS: Record<CourseWingPersona, string> = {
...
export function buildPersonaPrompt(persona: CourseWingPersona): string {
